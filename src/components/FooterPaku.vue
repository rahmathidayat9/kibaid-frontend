        ...
        <v-row>
          ...
          <v-col cols="12" sm="4" md="4" xl="4" class="order-1 order-sm-2 order-md-2 order-xl-2 mb-8">
            ...
            <template v-else>
              <v-row class="flex-column flex-wrap">
                <v-btn class="justify-start no-hover " text>
                  <router-link class="nav-link primary--text hover-text" to="/paku">
                ...
                <v-btn class="justify-start no-hover " text>
                  <router-link class="nav-link primary--text hover-text" to="/paku/about">
                    <span class="mr-2 text-capitalize">Tentang Kami</span>
                  </router-link>
                </v-btn>
                <v-btn class="justify-start no-hover " text>
                  <router-link class="nav-link primary--text hover-text" to="/paku/church">
                    <span class="mr-2 text-capitalize">Gereja</span>
                  </router-link>
                </v-btn>
                <v-btn class="justify-start no-hover " text>
                  <router-link class="nav-link primary--text hover-text" to="/paku/news">
