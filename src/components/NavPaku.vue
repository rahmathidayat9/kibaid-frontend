<template>
    <div>
      ...
      <v-navigation-drawer v-model="drawer" app temporary color="secondary">
        <v-list>
          <v-list-item @click.stop="$router.push('/paku/').catch(() => { });" class="brand-logo">
            <v-list-item-avatar>
            ...
            <v-col cols="12">
              <div class="d-flex align-center">
                <v-btn :ripple="false" width="200" large depressed link
                  @click.stop="$router.push('/paku/').catch(() => { });" color="transparent" elevation="0" class="no-hover  brand-name"
                  rounded>
                ...
                <template v-else>
                  ...
                  <div v-else>
                    <v-btn class="no-hover" text>
                      <router-link class="nav-link white--text hover-text" to="/paku">
                        <span class="mr-2">Home</span>
                      </router-link>
                    </v-btn>
                    <v-btn class="no-hover" text>
                      <router-link class="nav-link white--text hover-text" to="/paku/congregation">
                        <span class="mr-2">Jemaat</span>
                      </router-link>
                    </v-btn>
                    <v-btn class="no-hover" text>
                      <router-link class="nav-link white--text hover-text" to="/paku/church">
                    ...
                    <v-btn class="no-hover" text>
                      <router-link class="nav-link white--text hover-text" to="/paku/news">
  ...
  export default {
    data: () => ({
      ...
      items: [
        ...
        ["mdi-information-outline", "Jemaat", "#features"],
      ...
      links: [
        ...
        ["mdi-information-outline", "Jemaat", "congregation"],
