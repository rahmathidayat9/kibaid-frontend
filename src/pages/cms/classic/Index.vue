<template>
    <div class="">
        <h1 class="h3 mb-4 text-gray-800">Klasis</h1>
        <div class="row">
            <div class="col">
                <div class="card">
                    <div>
                        ...
                        <span v-if="props.column.field == 'action'">
                            ...
                            :to="{ name: 'cms.classic.edit', params: {id:props.row.id} }">
                            EDIT
                            </router-link>
...
export default {
    ...
    methods: {
        async getData() {
            ...
            let response = await axios.get(this.apiUrl+'classic')
        ...
        async deleteData(id) {
            await Swal.fire({
                ...
                let response = axios.delete(this.apiUrl+'classic/'+id)
                this.getData()
                Swal.fire(
